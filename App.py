...
THANA_LIST = [
    ...
    "गौरा चौराहा", "गैड़ास बुजुर्ग", "श्रीदत्तगंज", "ए0एच0टी0 थाना", "सीसीटीएनएस शाखा", "रिजर्व पुलिस लाइन", "महिला थाना", "साइबर क्राइम थाना"
]
...
# =============================================================
    ...
    if st.session_state.user_role == "hq_master":
        ...
        # === 🎯 मुख्यालय रैंडम ड्यूटी अलॉटमेंट टैब === (DISABLED/COMMENTED OUT)
        # Feature temporarily disabled by user
        # with tab3:
